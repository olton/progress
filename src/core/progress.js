...
export default class Progress {
    ...
    startMessage(){
        ...
        process.stdout.write(chalk[startMessageColor](startMessage.replace(/{{total}}/g, this.total)));
    ...
    completeMessage(){
        ...
        process.stdout.write('\n');
        process.stdout.write(chalk[completeMessageColor](completeMessage.replace(/{{total}}/g, this.total).replace(/{{elapsed}}/g, elapsed)));
        process.stdout.write('\n');
    }
